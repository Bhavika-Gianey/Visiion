...
class VisionArena(gym.Env):
	...
	def __init__(self):
		...
		p.setGravity(0,0,-15)
		self.plane=p.loadURDF('rsc/plane.urdf',[0,0,-0.1], useFixedBase=1)
		p.changeDynamics(self.plane, -1, lateralFriction = 10, spinningFriction = 10, rollingFriction = 10)
	...
	def __move(self, car, leftFrontWheel, rightFrontWheel, leftRearWheel, rightRearWheel):
		p.setJointMotorControl2(car,  4, p.VELOCITY_CONTROL, targetVelocity=leftFrontWheel, force=10000)
		p.setJointMotorControl2(car,  5, p.VELOCITY_CONTROL, targetVelocity=rightFrontWheel, force=10000)
		p.setJointMotorControl2(car,  6, p.VELOCITY_CONTROL, targetVelocity=leftRearWheel, force=10000)
		p.setJointMotorControl2(car,  7, p.VELOCITY_CONTROL, targetVelocity=rightRearWheel, force=10000)
